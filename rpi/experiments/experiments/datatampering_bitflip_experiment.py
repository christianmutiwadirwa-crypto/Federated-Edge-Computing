...
class DataTamperingBitFlipExperiment(BaseExperiment):
    """
    ...
    def cleanup(self) -> None:
        ...
        self.logger.info(f"[{self.name}] Data Tampering (BitFlip) complete: {self.sent} packets sent, {self.errors} errors.")
